namespace Lokf.Library.Infrastructure
{
    ...
    {
        /// <summary>
        /// Saves the events and stores them keyed by the aggregate ID. If the version of the aggregate in the event store differs from the expected version an optmistic concurreny exception is thrown.
        /// </summary>
